// File taken from https://github.com/olikraus/u8g2/blob/master/sys/bitmap/common/u8x8_d_bitmap.c
// Modified to replace u8g2.h include with clib/u8g2.h to work with U8g2_Arduino
